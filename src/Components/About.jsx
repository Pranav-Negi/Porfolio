...
export const About = () => {
  ...
  return (
    ...
    <div  className='flex mt-[8rem]  ml-[30vw] gap-6 '>   
         <div className='border-2 w-[20rem]'><img src="" alt="img soon" /></div>
            ...
            <div className='h-auto w-[30rem] flex flex-col gap-3'>
                ...
                <p className='text-[#666b6f]'>I am a Visual Designer with a strong focus on digital branding. Visual design seeks to attract, inspire, create desires and otivate people to respond to messages, with a view to making a favorable impact.</p>
